    ...
    with tf.Session() as sess:
        ...
        while True:
          ...
          _, step_loss, _ = model.step(sess, encoder_inputs, decoder_inputs,
                                       target_weights, bucket_id, forward_only=False,step=current_step)
          ...
          if current_step % FLAGS.steps_per_checkpoint == 0:
            ...
            for bucket_id in xrange(len(BUCKETS)):
              ...
              _, eval_loss, _ = model.step(sess, encoder_inputs, decoder_inputs, target_weights, bucket_id, True,step=current_step)
